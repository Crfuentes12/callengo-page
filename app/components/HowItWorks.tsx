          ...
          >
            <div className="relative">
              <div className="relative aspect-square overflow-hidden rounded-2xl border border-slate-700 bg-slate-900 shadow-xl">
                <Image
                  src="/callengo-dashboard-square.png"
                  alt="Callengo dashboard preview"
                  fill
          ...
          >
            ...
            <div className="space-y-8">
              {steps.map((step, index) => (
                ...
                >
                  <div className="shrink-0 w-12 h-12 rounded-full gradient-bg flex items-center justify-center text-sm font-semibold text-white">
                    {step.number}
                  </div>
                  <div>
