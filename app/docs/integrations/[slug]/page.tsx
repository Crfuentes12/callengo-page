...
const integrations: IntegrationDetail[] = [
  ...
  },
  {
    ...
    setup: [
      "Go to Settings > Integrations and click Connect next to Zapier.",
      "You will be redirected to Zapier — sign in or create a Zapier account.",
      "Search for 'Callengo' in Zapier's app directory.",
      "Choose a trigger (e.g., New Call Completed in Callengo) or an action (e.g., Start Campaign).",
      "Authenticate your Callengo account by entering your API key.",
      "Map fields between Callengo and your chosen app.",
      "Test the Zap and turn it on.",
    ],
    syncedData: [
      "Call results: outcome, sentiment, lead score, duration",
      "Contact data: name, phone, email, company, custom fields",
      "Campaign data: name, ID, status",
      "Transcript and recording URLs",
      "Extracted data fields from calls",
      "Appointment details (date, time, video link)",
      "Trigger events: call completed, campaign finished, lead qualified",
    ],
    useCases: [
      "Connecting Callengo to apps without native integration (e.g., Airtable, Notion, Monday.com).",
      "Building multi-step workflows: call completed > update CRM > send email > notify Slack.",
      "Triggering Callengo campaigns from form submissions, e-commerce events, or support tickets.",
      "Creating custom reporting pipelines that aggregate call data across multiple tools.",
    ],
    limitations: [
      "Zapier integration is coming soon — currently in development.",
      "Will require a Zapier account (free tier supports up to 100 tasks/month).",
      "Complex multi-step Zaps may require a Zapier paid plan.",
      "Real-time triggers depend on Zapier's polling interval (typically 1-15 minutes depending on plan).",
      "Available on Business plan and above.",
    ],
  },
];
      ...
      <main style={{ fontFamily: "var(--font-body)" }} className="bg-background">
        ...
        <section className="pb-20">
          <div className="max-w-4xl mx-auto px-6 space-y-12">
            ...
            {/* Plan requirement */}
            <div
              className="border border-border rounded-xl p-6 bg-background-secondary"
            >
