...
const agents = [
  ...
  },
  {
    ...
    icon: Zap,
    description: "Qualify and score leads before they reach your sales team",
    capabilities: [
      "Instant lead response (under 60 seconds)",
      "BANT qualification methodology",
      "Custom qualification questions",
      "Lead scoring and prioritization",
      "CRM updates with extracted data",
      "Warm handoff to sales reps",
    ],
    outcomes: [
      "Qualified - High Interest",
      "Qualified - Medium Interest",
      "Not Qualified",
      "Callback Requested",
      "No Answer",
      "Not Interested",
